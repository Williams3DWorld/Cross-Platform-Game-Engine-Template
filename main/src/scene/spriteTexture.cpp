...
namespace ast
{
    ...
    unsigned int& SpriteTexture::getTextureID()
    {
    ...
    void SpriteTexture::setTextureID(unsigned int value)
    {
    ...
    SpriteTexture::SpriteTexture(unsigned int textureID = 0, float uOffset = .0f, float vOffset = .0f, float uScale = 1.f, float vScale = 1.f, bool repeat = false) : _repeat(repeat), _uOffset(uOffset), _vOffset(vOffset), _uScale(uScale), _vScale(vScale), _textureID(textureID) {}
